const CACHE_NAME="rml-pliage-iphone-final-v4";
const URLS=["./","./index.html","./manifest.json","./header-logo.png","./apple-touch-icon.png","./icon-192.png","./icon-512.png"];
self.addEventListener("install",event=>{event.waitUntil(caches.open(CACHE_NAME).then(cache=>cache.addAll(URLS)));self.skipWaiting();});
